...
\label{tab:t1}
\small
\resizebox{\textwidth}{!}{\input{tab1.tex}}
\end{table}
...
\begin{figure}[!htbp]
\centering
\resizebox{0.95\textwidth}{!}{\input{fig2_prisma.tex}}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\textwidth]{../figures/fig3_corpus.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\textwidth]{../figures/fig4_screening.png}
...
\label{tab:t3}
\small
\resizebox{\textwidth}{!}{\input{tab3.tex}}
\end{table}
